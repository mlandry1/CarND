...
class FG_eval {
 public:
  ...
  void operator()(ADvector& fg, const ADvector& vars) {
     ...
     *  Put more weight on the cte and epsi than on the speed
     *  i.e.: we rather keep the car on the track than respect the speed setpoint..     *
     */
    for (int t = 0; t < N; t++) {
...
vector<double> MPC::Solve(Eigen::VectorXd state, Eigen::VectorXd coeffs) {
  ...
  // Set all to be 0 besides initial state.
